    ...
    <>
      ...
      <Container className={"my-24"}>
        <Row className={"items-center"}>
          ...
          <Col className={"w-full lg:w-6/12 gap-2 flex justify-evenly lg:justify-center items-center"}>
  <img
    src={volunteer1}
    alt="Jerrel Lustre digging around on a construction site, surrounded by other workers"
    className="border-2 border-white w-full h-full max-w-1/2 lg:mx-8 object-cover"
  />
  <img
    src={volunteer2}
